...
with open('E:/project1/backend/strengthen/data/train.csv','r') as  csvDataFile:
...
with open('E:/project1/backend/strengthen/data/test.csv','r') as  csvDataFile:
    csvReader = csv.reader(csvDataFile)        
...
df_train_all.to_csv('E:/project1/backend/strengthen/data/augmented_data.csv', header=False, index=False) 
